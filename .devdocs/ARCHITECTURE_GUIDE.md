...
- Example Unlocker verb/adjective lemma/reading extraction should allow up to 4 tokens when the leading token is verb/adjective; larger tokenizations still return `ambiguous_tokenization`.
